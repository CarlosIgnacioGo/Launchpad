 ...
 * @author Casa
 */
public class LibreriasPremium extends javax.swing.JFrame {

    /**
     * Creates new form LibreriasPremium
     */
    public LibreriasPremium() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Libreria " + libSelect + " cargada.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibreriasPremium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LibreriasPremium().setVisible(true);
            }
        });
    }
